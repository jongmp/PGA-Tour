...
rows = []
rows.append(['Player Name', 'Rounds', 'Average SG Putts', 'Total SG:Putts','Measured Rounds','Year'])
#print(rows)
...
for i in year_list:
    ...
    urlpage = 'https://www.pgatour.com/stats/stat.02564.' + i + '.html'
    ...
    for result in results:
        ...
        rows.append([name, rounds, average, total_sg_putt, total_round, year])

    print(rows)

# Create a csv file and write rows to the file
with open('sgPutting.csv', 'w', newline='') as f_output:
