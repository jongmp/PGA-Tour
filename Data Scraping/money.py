...
rows = []
rows.append(['Player Name', 'Events','Money', 'YTD Victories','Year'])
#print(rows)
...
for i in year_list:
    ...
    urlpage = 'https://www.pgatour.com/stats/stat.109.' + i + '.html'
    ...
    for result in results:
        ...
        rows.append([name, event, money, ytd, year])

    print(rows)

# Create a csv file and write rows to the file
with open('money.csv', 'w', newline='') as f_output:
